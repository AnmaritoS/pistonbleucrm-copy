const Shell = ({ children }) => {
  return (
    <div class="antialiased bg-bunker-50 dark:bg-bunker-900">
      <nav class="bg-white px-4 py-2.5 dark:bg-bunker-950 fixed left-0 right-0 top-0 z-50">
        <div class="flex flex-wrap justify-between items-center">
          <div class="flex justify-start items-center">
            ...
            <a href="https://pistonbleu.fr" class="flex items-center justify-between mr-4">
              <img src="/logo.svg" class="mr-3 h-8" alt="Piston Bleu Logo" />
            </a>
            <form action="#" method="GET" class="hidden md:block md:pl-2">
              ...
              <div class="relative md:w-64">
                ...
                <input
                  ...
                  name="email"
                  id="topbar-search"
                  class="bg-bunker-50 text-bunker-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-bunker-900 dark:placeholder-bunker-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                  placeholder="Search"
                />
              </div>
            </form>
          ...
          <div class="flex items-center lg:order-2">
            ...
            {/* <!-- Dropdown menu --> */}
            <div
              class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-bunker-100 shadow-lg dark:divide-bunker-600 dark:bg-bunker-900"
              id="notification-dropdown"
            >
              <div class="block py-2 px-4 text-base font-medium text-center text-bunker-700 bg-bunker-50 dark:bg-bunker-600 dark:text-bunker-300">
                Notifications
              </div>
              <div>
                <a href="#" class="flex py-3 px-4 border-b hover:bg-bunker-100 dark:hover:bg-bunker-600">
                  <div class="flex-shrink-0">
                    ...
                    />
                    <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-primary-700 dark:border-bunker-700">
                ...
                <a href="#" class="flex py-3 px-4 border-b hover:bg-bunker-100 dark:hover:bg-bunker-600">
                  <div class="flex-shrink-0">
                    ...
                    />
                    <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-bunker-900 rounded-full border border-white dark:border-bunker-700">
                      <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="#" class="flex py-3 px-4 border-b hover:bg-bunker-100 dark:hover:bg-bunker-600">
                  <div class="flex-shrink-0">
                    ...
                    />
                    <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-red-600 rounded-full border border-white dark:border-bunker-700">
                      <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                          fill-rule="evenodd"
                ...
                <a href="#" class="flex py-3 px-4 border-b hover:bg-bunker-100 dark:hover:bg-bunker-600">
                  <div class="flex-shrink-0">
                    ...
                    />
                    <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-green-400 rounded-full border border-white dark:border-bunker-700">
                      <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path
                          fill-rule="evenodd"
                ...
                <a href="#" class="flex py-3 px-4 hover:bg-bunker-100 dark:hover:bg-bunker-600">
                  <div class="flex-shrink-0">
                    <img
                      class="w-11 h-11 rounded-full"
                      ...
                      alt="Robert image"
                    />
                    <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 bg-purple-500 rounded-full border border-white dark:border-bunker-700">
                      <svg aria-hidden="true" class="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <a
                href="#"
                class="block py-2 text-md font-medium text-center text-bunker-900 bg-bunker-50 hover:bg-bunker-100 dark:bg-bunker-600 dark:text-white dark:hover:underline"
              >
            ...
            {/* <!-- Dropdown menu --> */}
            <div
              class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-bunker-100 shadow-lg dark:bg-bunker-900 dark:divide-bunker-600"
              id="apps-dropdown"
            >
              <div class="block py-2 px-4 text-base font-medium text-center text-bunker-700 bg-bunker-50 dark:bg-bunker-600 dark:text-bunker-300">
                Apps
              ...
              <div class="grid grid-cols-3 gap-4 p-4">
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Sales</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Users</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Inbox</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Profile</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Settings</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Products</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Pricing</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Billing</div>
                </a>
                <a href="#" class="block p-4 text-center rounded-lg hover:bg-bunker-100 dark:hover:bg-bunker-600 group">
                  <svg
                    aria-hidden="true"
                  ...
                  <div class="text-sm text-bunker-900 dark:text-white">Logout</div>
                </a>
              </div>
            </div>
            <button
      ...
      <aside
        class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full bg-white md:translate-x-0 dark:bg-bunker-950"
        aria-label="Sidenav"
        id="drawer-navigation"
      >
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-bunker-950">
          <form action="#" method="GET" class="md:hidden mb-2">
            ...
            <div class="relative">
              ...
              <input
                ...
                name="search"
                id="sidebar-search"
                class="bg-bunker-50 text-bunker-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-bunker-900 dark:placeholder-bunker-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Search"
              />
            </div>
          </form>
          <ul class="space-y-2">
            <li>
              <a
                href="#"
                class="flex items-center p-2 text-base font-medium text-bunker-900 rounded-lg dark:text-white hover:bg-bunker-100 dark:hover:bg-bunker-700 group"
              >
                <svg
                  aria-hidden="true"
            ...
            <li>
              <button
                type="button"
                class="flex items-center p-2 w-full text-base font-medium text-bunker-900 rounded-lg transition duration-75 group hover:bg-bunker-100 dark:text-white dark:hover:bg-bunker-700"
              ...
              >
                ...
                <span class="flex-1 ml-3 text-left whitespace-nowrap">Demandes</span>
                <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fill-rule="evenodd"
              ...
              <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                <li>
                  <a
                    href="#"
                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-bunker-900 rounded-lg transition duration-75 group hover:bg-bunker-100 dark:text-white dark:hover:bg-bunker-700"
                  >
                    Settings
                  </a>
                </li>
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ml-3 text-left whitespace-nowrap">Ventes</span>
                <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fill-rule="evenodd"
                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
          ...
          <ul class="pt-5 mt-5 space-y-2 border-t border-bunker-200 dark:border-bunker-700">
            <li>
              <a
                href="#"
                class="flex items-center p-2 text-base font-medium text-bunker-900 rounded-lg transition duration-75 hover:bg-bunker-100 dark:hover:bg-bunker-700 dark:text-white group"
              >
                <svg
                  aria-hidden="true"
                  class="flex-shrink-0 w-6 h-6 text-bunker-500 transition duration-75 dark:text-bunker-400 group-hover:text-bunker-900 dark:group-hover:text-white"
        ...
        <div class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-bunker-950 z-20">
          ...
          <div
            id="tooltip-settings"
            role="tooltip"
            class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-bunker-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip"
          >
            Settings page
          ...
          {/* <!-- Dropdown --> */}
          <div
            class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-bunker-100 shadow dark:bg-bunker-900"
          ...
          >
            <ul class="py-1" role="none">
              <li>
                <a
                  href="#"
                  class="block py-2 px-4 text-sm text-bunker-700 hover:bg-bunker-100 dark:hover:text-white dark:text-bunker-300 dark:hover:bg-bunker-600"
                  role="menuitem"
                >
                  <div class="inline-flex items-center">
                    <svg
              ...
              <li>
                <a
                  href="#"
                  class="block py-2 px-4 text-sm text-bunker-700 hover:bg-bunker-100 dark:text-bunker-300 dark:hover:text-white dark:hover:bg-bunker-600"
                  role="menuitem"
                >
                  <div class="inline-flex items-center">
                    <svg
